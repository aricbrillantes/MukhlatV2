    ...
    <div class="modal-dialog" >
        ...
        <div class="modal-content">
            <div class="modal-header modal-heading modalbg">
                ...
                <h4 class="modal-title text-center textoutliner"><strong><?php echo $child->first_name; ?>'s Uploaded Files</strong></h4>
            </div>

            <div class="modal-body content-container container-fluid tab-content" style="background: #ebebeb">
                ...
                <div class="tab-content">
                    ...
                    <div id="pictures" class = "col-sm-12 col-xs-12 col-md-12 tab-pane fade in active" style = "margin-bottom: 40px; max-height:300px; overflow-x: hidden; overflow-y: scroll">
                        <?php foreach ($activities as $post): ?> 
                            ...
                            <?php foreach ($attachments as $attachment):?>
                                <center>
                                <div class = "col-xs-12 col-md-12 col-sm-12 no-padding" style = "">
                                    <?php if ($attachment->attachment_type_id === '1'):?>
                                        ...
                                        <br><img src = "<?= base_url($attachment->file_url); ?>" width = "75%"  style="position:relative; width:auto; max-height: 150px; max-width: 250px; margin-bottom: 20px; " />
                        ...
                        <?php foreach ($activities as $post): ?> 
                            ...
                            <?php foreach ($attachments as $attachment):?>
                                ...
                                <div class = "col-xs-10 no-padding" style = "">
                                    ...
                                    <?php elseif ($attachment->attachment_type_id === '2'): ?>
                                        <span class = "text-muted"> <i style = "font-size: 11px">(<?php echo date("M-d-y", strtotime($post->date_posted)); ?>)</i></span>
                                        <br><audio src = "<?= base_url($attachment->file_url); ?>" style="width: 100%" controls></audio>
                        ...
                        <?php foreach ($activities as $post): ?> 
                            ...
                            <?php foreach ($attachments as $attachment):?>
                                ...
                                <div class = "col-xs-10 no-padding" style = "">
                                    ...
                                    <?php elseif ($attachment->attachment_type_id === '3'): ?>
                                        <span class = "text-muted"> <i style = "font-size: 11px">(<?php echo date("M-d-y", strtotime($post->date_posted)); ?>)</i></span>
                                        <br><video src = "<?= base_url($attachment->file_url); ?>" width = "100%" style="height: 100%; width:auto; max-height: 250px;" controls/></video>

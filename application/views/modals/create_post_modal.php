            ...
            <div id="stickerchoices">     
                ...
                <div class="tab-content">
                    <div id="emoticats" class="tab-pane fade in active">
                        ...
                        <img class="stickerhov iconin" width="20%" height="auto" src="<?php echo base_url('images/stickers/love.png'); ?>" onclick="var keep= $('[id$=post-content]').val();doBack();emojisICON();keeper(keep, ';love 1;');"/>

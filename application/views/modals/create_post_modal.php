                  ...
                  <div id="uploadmedia">
                    ...
                    <div class="tab-content">
                      <div id="picturetab" class="tab-pane fade in active">
                          ...
                          <button type="button" id="btnpic" class="drawnbutton lined thin" onclick="cameraclick();"><img src="<?php echo base_url('icons/Camera.png'); ?>" style="display:block;margin: 0 auto;margin-bottom: 15px;margin-top: 10px"></img>Take a Pic!</button>
                          </div>

...
<div class="themesmodal">
    ...
    <div class="hider"><br><br></div>
                ...
                <center><strong id="stickyinput" class="stickynote stickytext stickyact cursornone" style="font-size: 24px;background-color:<?php echo "#".$c_topic->shoutout?>">Memo</strong></center>

...
<nav class = "navbar navbar-default navbar-font navbar-fixed-top" style = "border-bottom: 1px solid #CFD8DC;">
    <div class = "container-fluid">
        <a class = "pull-left btn btn-topic-header" style = "display: inline-block; margin-right: 5px; border:0" href="<?php echo base_url('parents/advanced/' . $child->user_id) ?>">
        ...
        <div class = "row">
            ...
            <div class = "col-md-8 col-md-offset-2 content-container container-fluid" style = "margin-bottom: 4.5px;"><br>
                ...
                <div class = "col-xs-12 form-group register-field" style = "">
                    ...
                    <?php if ($mobile): ?>
                        <br><br><h3 class = "col-xs-8 col-sm-4 col-md-4 no-padding text-info"style = "margin-bottom: 0px; margin-top: 0px;"><u>New Settings</u></strong></h3>
                         
                    <?php else: ?>
                        <h3 class = "col-xs-8 col-sm-4 col-md-4 no-padding text-info pull-right"style = "margin-bottom: 0px; margin-top: 0px;"><u>New Settings</u></strong></h3>

...
<script>
    $(function() 
    {
        ...
        {
            var newDiv = 
            $('<div class = "col-xs-7 form-group register-field" style = "font-size:14px;"><h3 class = "no-padding text-info"style = "margin-bottom: 5px; margin-top: 0px;">sasasasas</h3><button id="btnRemovefromList">Remove from list</button></div>');

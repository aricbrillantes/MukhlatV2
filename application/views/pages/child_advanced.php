        ...
        <div class = "row">
            ...
            <div class = "col-md-8 col-md-offset-2 content-container container-fluid" style = "margin-bottom: 4.5px;"><br>
                ...
                <div class = "col-xs-12 form-group register-field" style = "">
                    ...
                    <?php if ($mobile): ?>
                        <h3 class = "col-xs-12 col-md-6 no-padding text-info pull-left"style = "margin-bottom: 0px; margin-top: 0px;">NEW Settings </strong></h3>
                         
                    <?php else: ?>
                        <h3 class = "col-xs-12 col-md-6 no-padding text-info pull-left"style = "margin-bottom: 0px; margin-top: 0px;">New    </strong></h3>

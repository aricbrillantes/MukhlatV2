...
<!--            </div>
            ...
            <?php if ($c_topic->creator_id === $logged_user->user_id): ?>
                <button onmouseenter="playclip()" onclick="toggleButton('shout')" id="crettop" class = "btn btn-primary buttonsbgcolor textoutliner" href="#create-post-modal" data-toggle = "modal" style="font-size:22px;margin-top: 2%;margin-left: 50px; margin-right: 100%">My Memo</button><br><br>
                <?php endif;?>
            </ul>

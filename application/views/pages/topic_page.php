...
<!--<strong>Theme: <?php echo utf8_decode($c_topic->theme); ?></strong>-->
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3  hider" style="min-width: 450px !important;">
                ...
                <div class="white-board" style="min-height:50%; max-height:195px;border-color: <?php echo $bulletin?>">
                    <h3> <mark class="textoutliner" style="border-radius: 20px;color:white;border-color: <?php echo $bulletin?>">Teacher</mark></h3> 
                        <?php 
                    //load models
                    $CI =&get_instance();
                ...
                <div class="white-board" style=" min-height:50%; max-height:195px;border-color: <?php echo $bulletin2?>">
                    <h3> <mark class="textoutliner" style="border-radius: 20px;color:white;border-color: <?php echo $bulletin2?>">Guardians</mark></h3> 
                    <?php 
                    $CI =&get_instance();

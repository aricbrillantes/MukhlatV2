...
<!--<strong>Theme: <?php echo utf8_decode($c_topic->theme); ?></strong>-->
            ...
            <div id="chalkb" class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9 chalkboard" style="min-height:200px; max-height:200px;margin-top: 60px;border-color: <?php echo $board?>">
                    ...
                    <?php if(!$attachments):?>
                            <p style = "border-right: none; max-width: 714px;padding: 3%;max-height: 50%;font-family: KGChasingPavements;overflow-wrap: break-word;"><?php echo utf8_decode($post->post_content); ?>
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3  hider" style="min-width: 450px !important;">
                ...
                <div class="white-board" style=" min-height:50%; max-height:195px;border-color: <?php echo $bulletin2?>;overflow-x:hidden;">
                    ...
                    <h4>Your guardian has not sent any notes yet.</h4>
                    <?php endif;?>

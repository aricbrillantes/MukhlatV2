...
class Post_model extends CI_Model {
    ...
    public function get_user_activities($user_id, $logged_user_id) {
        $this->db->select('p.post_id, p.post_title, p.post_content, p.date_posted, p.root_id, p.parent_id, t.topic_id, t.topic_name, t.theme, u1.user_id, p.reply, p.shout, p.is_deleted, u1.first_name, u1.last_name, u1.profile_url');
